...
$this->params['buttons'] = [
    'update' => (Yii::$app->user->can('admin') or Yii::$app->user->can('updateGroups')) ? Html::a('<i class="fas fa-edit text-primary"></i> Изменить', ['update', 'id' => $model->id], ['class' => 'btn btn-app']) : null,
    ...
    'undo' => Html::a('<i class="far fa-arrow-alt-circle-left text-muted"></i>Вернуться', ['group/index'], ['class' => 'btn btn-app'])
];
?>
            ...
            <div class="card">
                <div class="card-body d-block d-sm-none p-2">
                    <table class="table table-striped table-bordered mb-0">
                        ...
                        <tr>
                            <td><p class="mb-0"><b>Сотрудники: </b><?= HtmlPurifier::process($model->getUsers($model->user)) ?></p></td>
                        </tr>
                        <tr>
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    'attribute' => 'user',
                                    'format' => 'raw',
                                    'value' =>  $model->getUsers($model->user),
                                ],
                                [
                                    'attribute' => 'status',
