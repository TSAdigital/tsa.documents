...
$this->params['buttons'] = [
    'update' => (Yii::$app->user->can('admin') or Yii::$app->user->can('updatePositions')) ? Html::a('<i class="fas fa-edit text-primary"></i> Изменить', ['update', 'id' => $model->id], ['class' => 'btn btn-app']) : null,
