            ...
            <div class="comment-footer">
                ...
                <span class="dropdown">
                    ...
                    <span class="dropdown-menu">
                        ...
                        <?= (Yii::$app->user->can('admin') or $model->user_id == Yii::$app->user->identity->id) ? Html::a('Удалить', ['task/discussion-delete', 'id' => $task->id, 'discussion' => $model->id], ['class' => 'dropdown-item']) : null ?>
