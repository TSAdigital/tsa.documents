...
HTML;
$script = <<< JS
    jQuery('input[id=tasksearch-date_from], input[id=tasksearch-date_to]').attr('autocomplete', 'off');
JS;
...
<div class="task-search">
    ...
    <?= $form->field($model, 'priority')->textInput()->dropDownList($model->getPrioritysArray(), ['prompt' => 'Выберите приоритет...']) ?>
